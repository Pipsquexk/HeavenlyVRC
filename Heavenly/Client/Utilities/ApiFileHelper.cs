...
{
    public static class ApiFileHelper
    {
        private static readonly int kMultipartUploadChunkSize = 10 * 1024 * 1024;
        ...
        private static readonly Regex[] kUnityPackageAssetNameFilters = new Regex[]
        {
        ...
        {
            MelonCoroutines.Start(UploadFile(filename, existingFileId, friendlyName, onSuccess, onError,
        ...
        public static string GetMimeTypeFromExtension(string extension)
        {
            ...
            MelonLogger.Msg("Unknown file extension for mime-type: " + extension);
        ...
        public static IEnumerator UploadFile(string filename, string existingFileId, string friendlyName,
            OnFileOpSuccess onSuccess, OnFileOpError onError, OnFileOpProgress onProgress, FileOpCancelQuery cancelQuery)
        {
            ...
            if (!ConfigManager.RemoteConfig.IsInitialized())
            {
                ...
                ConfigManager.RemoteConfig.Init(
                    DelegateSupport.ConvertDelegate<Il2CppSystem.Action>(new System.Action(
                    delegate () { done = true; })),
                    DelegateSupport.ConvertDelegate<Il2CppSystem.Action>(new System.Action(
                    delegate () { done = true; }))
                );
            ...
            while (true)
            {
                ...
                if (string.IsNullOrEmpty(existingFileId))
                    ...
                    VRC.Core.API.Fetch<ApiFile>(existingFileId, fileSuccess, fileFailure);
                ...
                if (!string.IsNullOrEmpty(errorStr))
                {
                    ...
                    {
                        MelonLogger.Msg("Couldn't find file record: " + existingFileId + ", creating new file record");
            ...
            while (apiFile.HasQueuedOperation(EnableDeltaCompression))
            {
                ...
                apiFile.DeleteLatestVersion(
                    DelegateSupport.ConvertDelegate<Il2CppSystem.Action<ApiContainer>>(new System.Action<ApiContainer>(
                    (c) => wait = false)),
                    DelegateSupport.ConvertDelegate<Il2CppSystem.Action<ApiContainer>>(new System.Action<ApiContainer>(
                    (c) => wait = false)));
            ...
            {
                MelonLogger.Msg("ApiFile: " + apiFile.id + ": server failed to process last uploaded, deleting failed version");
            ...
            VRC.Tools.FileMD5(uploadFilename,
                DelegateSupport.ConvertDelegate<Il2CppSystem.Action<Il2CppStructArray<byte>>>(new System.Action<Il2CppStructArray<byte>>(
                delegate (Il2CppStructArray<byte> md5Bytes)
                {
                    fileMD5Base64 = System.Convert.ToBase64String(md5Bytes);
                    wait = false;
                })),
                DelegateSupport.ConvertDelegate<Il2CppSystem.Action<string>>(new System.Action<string>(
                delegate (string error)
                {
            ...
            if (apiFile.HasExistingOrPendingVersion())
            {
                ...
                if (string.Compare(fileMD5Base64, apiFile.GetFileMD5(apiFile.GetLatestVersionNumber())) == 0)
                {
                    ...
                    else
                    {
                        ...
                        MelonLogger.Msg("Retrying previous upload");
                    }
                }
                else
                {
            ...
            VRC.Tools.FileMD5(signatureFilename,
                ...
                delegate (Il2CppStructArray<byte> md5Bytes)
                {
                    sigMD5Base64 = System.Convert.ToBase64String(md5Bytes);
                    wait = false;
                })),
                DelegateSupport.ConvertDelegate<Il2CppSystem.Action<string>>(new System.Action<string>(
                delegate (string error)
            ...
            if (EnableDeltaCompression && apiFile.HasExistingVersion())
            {
                ...
                apiFile.DownloadSignature(
                    DelegateSupport.ConvertDelegate<Il2CppSystem.Action<Il2CppStructArray<byte>>>(new System.Action<Il2CppStructArray<byte>>(
                    delegate (Il2CppStructArray<byte>  data)
                    {
                        // save to temp file
                    ...
                    DelegateSupport.ConvertDelegate<Il2CppSystem.Action<long, long>>(new System.Action<long, long>(
            ...
            if (uploadDeltaFile)
            {
                ...
                VRC.Tools.FileMD5(deltaFilename,
                    ...
                    delegate (Il2CppStructArray<byte> md5Bytes)
                    {
                        deltaMD5Base64 = System.Convert.ToBase64String(md5Bytes);
                        wait = false;
                    })),
                    DelegateSupport.ConvertDelegate<Il2CppSystem.Action<string>>(new System.Action<string>(
                    delegate (string error)
            ...
            if (isPreviousUploadRetry)
            {
                ...
                if (isValid)
                {
                    ...
                    MelonLogger.Msg("Using existing version record");
                }
                else
                {
            ...
            if (uploadDeltaFile)
            {
                if (apiFile.GetLatestVersion().delta.status == ApiFile.Status.Waiting)
                {
                    ...
                    yield return MelonCoroutines.Start(UploadFileComponentInternal(apiFile,
                        ...
                        {
                            MelonLogger.Msg("Successfully uploaded file delta.");
                            apiFile = file;
                        },
                        delegate (string error)
                        {
            ...
            while (apiFile.HasQueuedOperation(uploadDeltaFile))
            {
                ...
                while (true)
                {
                    ...
                    worthRetry = false;
                    errorStr = "";
                    VRC.Core.API.Fetch<ApiFile>(apiFile.id, fileSuccess, fileFailure);
        ...
        private static void LogApiFileStatus(ApiFile apiFile, bool checkDelta, bool logSuccess = false)
        {
            ...
            {
                MelonLogger.Msg("apiFile not initialized");
            }
            else if (apiFile.IsInErrorState())
            {
                MelonLogger.Msg($"ApiFile {apiFile.name} is in an error state.");
            }
            else if (logSuccess)
        ...
        public static IEnumerator CreateOptimizedFileInternal(string filename, string outputFilename, System.Action<FileOpResult> onSuccess, System.Action<string> onError)
        {
            ...
            if (isUnityPackage)
            {
                try
                {
                    ...
                    System.Collections.Generic.List<string> assetGuidsToStrip = new System.Collections.Generic.List<string>();
                    {
                        ...
                        while (tarEntry != null)
                        {
                            if (tarEntry.Size > 0 && tarEntry.Name.EndsWith("/pathname", System.StringComparison.OrdinalIgnoreCase))
                            {
                                ...
                                if (bytesRead > 0)
                                {
                                    ...
                                    if (kUnityPackageAssetNameFilters.Any(r => r.IsMatch(assetFilename)))
                                    {
                                        ...
                                        // MelonLogger.Msg("-- stripped file from package: " + assetGuid + " - " + assetFilename);
            ...
            MelonLogger.Msg("CreateOptimizedFile: Android unsupported");
            if (onSuccess != null)
                onSuccess(FileOpResult.Unchanged);
            yield break;
        }

        public static IEnumerator CreateFileSignatureInternal(string filename, string outputSignatureFilename, System.Action onSuccess, System.Action<string> onError)
        {
            ...
            System.IAsyncResult asyncRead = null;
            System.IAsyncResult asyncWrite = null;
        ...
        public static IEnumerator CreateFileDeltaInternal(string newFilename, string existingFileSignaturePath, string outputDeltaFilename, System.Action onSuccess, System.Action<string> onError)
        {
            MelonLogger.Msg("CreateFileDelta: " + newFilename + " (delta) " + existingFileSignaturePath + " => " + outputDeltaFilename);
        ...
        public static void Success(OnFileOpSuccess onSuccess, ApiFile apiFile, string message)
        {
            if (apiFile == null)
                apiFile = new ApiFile();
        ...
        public static void Error(OnFileOpError onError, ApiFile apiFile, string error, string moreInfo = "")
        {
            if (apiFile == null)
                apiFile = new ApiFile();

            MelonLogger.Msg("ApiFile " + apiFile.ToStringBrief() + ": Error: " + error + "\n" + moreInfo);
            if (onError != null)
                onError(apiFile, error);
        }

        public static void Progress(OnFileOpProgress onProgress, ApiFile apiFile, string status, string subStatus = "", float pct = 0.0f)
        {
            if (apiFile == null)
                apiFile = new ApiFile();
        ...
        public static bool CheckCancelled(FileOpCancelQuery cancelQuery, OnFileOpError onError, ApiFile apiFile)
        {
            if (apiFile == null)
            {
                MelonLogger.Msg("apiFile was null");
                return true;
            }

            if (cancelQuery != null && cancelQuery(apiFile))
            {
                MelonLogger.Msg("ApiFile " + apiFile.ToStringBrief() + ": Operation cancelled");
                if (onError != null)
        ...
        public static void CleanupTempFiles(string subFolderName)
        {
            MelonCoroutines.Start(CleanupTempFilesInternal(subFolderName));
        }

        public static IEnumerator CleanupTempFilesInternal(string subFolderName)
        {
        ...
        private static bool uploadFileComponentValidateFileDesc(ApiFile apiFile, string filename, string md5Base64, long fileSize, ApiFile.Version.FileDescriptor fileDesc, System.Action<ApiFile> onSuccess, System.Action<string> onError)
        {
            if (fileDesc.status != ApiFile.Status.Waiting)
            {
                // nothing to do (might be a retry)
                MelonLogger.Msg("UploadFileComponent: (file record not in waiting status, done)");
                if (onSuccess != null)
                    onSuccess(apiFile);
                return false;
            }
        ...
        private static IEnumerator uploadFileComponentDoSimpleUpload(ApiFile apiFile, ApiFile.Version.FileDescriptor.Type fileDescriptorType, string filename, string md5Base64, long fileSize, System.Action<ApiFile> onSuccess, System.Action<string> onError, System.Action<long, long> onProgess, FileOpCancelQuery cancelQuery)
        {
            ...
            while (true)
            {
                ...
                apiFile.StartSimpleUpload(fileDescriptorType,
                    ...
                    (c) =>
                    {
                        uploadUrl = Serialization.FromIL2CPPToManaged<string>((((ApiDictContainer)c).ResponseDictionary["url"]));
                        wait = false;
                    })),
                    DelegateSupport.ConvertDelegate<Il2CppSystem.Action<ApiContainer>>(new System.Action<ApiContainer>(
                    (c) =>
        ...
        private static IEnumerator uploadFileComponentDoMultipartUpload(ApiFile apiFile, ApiFile.Version.FileDescriptor.Type fileDescriptorType, string filename, string md5Base64, long fileSize, System.Action<ApiFile> onSuccess, System.Action<string> onError, System.Action<long, long> onProgess, FileOpCancelQuery cancelQuery)
        {
            FileStream fs = null;
            OnFileOpError onCancelFunc = delegate (ApiFile file, string s)
            {
        ...
        private static IEnumerator uploadFileComponentVerifyRecord(ApiFile apiFile, ApiFile.Version.FileDescriptor.Type fileDescriptorType, string filename, string md5Base64, long fileSize, ApiFile.Version.FileDescriptor fileDesc, System.Action<ApiFile> onSuccess, System.Action<string> onError, System.Action<long, long> onProgess, FileOpCancelQuery cancelQuery)
        {
            OnFileOpError onCancelFunc = delegate (ApiFile file, string s)
            {
                if (onError != null)
        ...
        private static IEnumerator UploadFileComponentInternal(ApiFile apiFile, ApiFile.Version.FileDescriptor.Type fileDescriptorType, string filename, string md5Base64, long fileSize, System.Action<ApiFile> onSuccess, System.Action<string> onError, System.Action<long, long> onProgess, FileOpCancelQuery cancelQuery)
        {
